...
から振幅情報と位相情報を取り出してみましょう。取り出すと以下の図のようになります。[code](../prog/ps/ex3.m)
...
片側スペクトル
<img src="https://latex.codecogs.com/gif.latex?Z(f)" />
に対して、振幅スペクトルは
<img src="https://latex.codecogs.com/gif.latex?|Z(f)|" />
であり、位相スペクトルは
<img src="https://latex.codecogs.com/gif.latex?\tan^{-1}\left(\frac{Im\{Z(f)\}}{Re\{Z(f)\}}\right)" />
